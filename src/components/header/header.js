  ...
  <header className="mb-12 relative">
    ...
    >
      {user.is_customer && (
        <Link
          href="/"
          className={`w-full px-4 py-2 rounded-xl text-center font-medium text-sm
            ${
    ...
    <div className="absolute top-6 right-6">
      <Link
        href="/logout"
        className={`px-4 py-2 rounded-2xl text-sm font-medium border border-white text-white
